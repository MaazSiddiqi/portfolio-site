...
function App() {
  return (
    <main className="flex flex-col justify-center min-h-screen w-screen">
      <CustomCursor />
      <div className="absolute grid place-items-center top-[50%] left-[50%] w-screen h-screen overflow-clip -translate-x-1/2 -translate-y-1/2 object-cover -z-10 pointer-events-none">
        <motion.img
          src="/images/name.png"
          alt="name"
